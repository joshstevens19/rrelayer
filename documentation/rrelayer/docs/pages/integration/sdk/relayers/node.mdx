...
// Returns ImportRelayerResult - import { ImportRelayerResult } from 'rrelayer';
const importResult = await client.relayer.import(
  11155111, // chainId
  'my-imported-relayer', // name
  'arn:aws:kms:us-east-1:123456789012:key/abc123-def456-ghi789', // keyId (KMS key ARN)
  '0x742d35cc6466c4b0de3e3e8c7b8e8f9e8a8d8c8b' // address (must match the key's actual address)
);

// importResult.id = relayer id
// importResult.address = relayer address
// importResult.walletIndex = assigned wallet index
// importResult.keyAlias = KMS alias created (e.g., "alias/rrelayer-wallet-0-11155111")
