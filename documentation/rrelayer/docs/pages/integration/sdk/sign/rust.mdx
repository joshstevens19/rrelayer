...
pub type Response = ApiResult<SignTextResult>; // [!code focus]
```
...
pub type Response = ApiResult<PagingResult<SignedTextHistory>>; // [!code focus]
```
...
pub type Response = ApiResult<SignTypedDataResult>; // [!code focus]
```
...
pub type Response = ApiResult<PagingResult<SignedTypedDataHistory>>; // [!code focus]
```
