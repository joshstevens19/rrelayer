...
| --------- | -------- | -------- | ------------------------ |
| `message` | `string` | Yes      | The text message to sign |
...
```json
{
  ...
  "message": "Hello, World! Please sign this message to authenticate.",
  "relayer_address": "0x742d35cc6466c4b0de3e3e8c7b8e8f9e8a8d8c8b"
}
```
...
```bash
curl -X POST https://your-rrelayer.com/api/signing/0x742d35.../message \
  -u "username:password" \
...
```bash
curl -X POST https://your-rrelayer.com/api/signing/0x742d35.../typed-data \
  -u "username:password" \
  -H "Content-Type: application/json" \
  -d '{
    "domain": {
  ...
  "signatures": [
    {
      ...
      "signed_at": "2025-09-26T10:30:00Z"
    }
  ],
  "total": 1
}
...
```bash
curl "https://your-rrelayer.com/api/signing/0x742d35.../text-history?limit=10" \
  -u "username:password"
```
  ...
  "signatures": [
    {
      ...
      "signed_at": "2025-09-26T10:35:00Z"
    }
  ],
  "total": 1
}
...
```bash
curl "https://your-rrelayer.com/api/signing/0x742d35.../typed-data-history?limit=10" \
  -u "username:password"
```
...
curl -X POST https://your-rrelayer.com/api/signing/0x742d35.../message \
  ...
  -H "Content-Type: application/json" \
  -d '{
    "message": "Authenticate with MyApp at 2025-09-26T10:30:00Z"
  }'
```
