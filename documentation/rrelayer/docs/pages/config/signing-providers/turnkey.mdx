...
You can get turnkey credentials from the Turnkey developer dashboard or Turnkey CLI. See Turnkey's [Getting Started documentation](https://docs.turnkey.com/getting-started/quickstart) for more details.
