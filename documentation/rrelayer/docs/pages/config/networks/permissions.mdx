...
### ip_allowlist and request_verification - optional request controls

Permission entries can require a source IP and a strict HS256 JWT for mutation
and signing routes. Omission preserves existing behavior;
