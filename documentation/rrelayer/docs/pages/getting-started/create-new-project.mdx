...
is not the securest to run as the seed is in the `env`, but rrelayer offers many signing key provider which you can find out more [here](/config/signing-providers/aws-kms).
...
relayer offers many signing key provider which you can find out more [here](/config/signing-providers/aws-kms).
