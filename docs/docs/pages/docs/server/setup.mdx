...
Once installed you can cd into the folder `rrelayerr_server`
...
You will need to replace the `${}` with the correct environment variables names. rrelayerr will see anything with ${} and replace it with the environment variable.
